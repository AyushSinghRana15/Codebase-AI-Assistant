    ...
    <section className="border-y py-10 overflow-hidden" style={{ background: "var(--bg-secondary)", borderColor: "var(--border-subtle)" }}>
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row items-center gap-4 mb-6">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium" style={{ background: "rgba(59,130,246,0.1)", color: "#3b82f6", border: "1px solid rgba(59,130,246,0.2)" }}>
            <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
            {`80%+ RAGAS eval · sub-2s answers · 0 hallucinations on test set`}
          </div>
